...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.5.0-beta.6.xcframework.zip",
			checksum: "0915d8f8c2471dab33e9860a2fb3b535f9c7faa861ece903c572461e1cd55df7"
		)
	]
)