...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.2.0-beta.19.xcframework.zip",
			checksum: "cd2e4f87322a08ed3e87a6de87ab871b9798fa14b0f74268c1621f16b7e449a6"
		)
	]
)