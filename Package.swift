...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-3.1.0-rc.8.xcframework.zip",
			checksum: "66f624580a01ac41eb810f22535c2c51b39ea00d43a13732e2a5a6c2c900e44c"
		)
	]
)