...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.0.0-beta.25.xcframework.zip",
			checksum: "72afe050a283f8bdd2b9e34423c07f9407b5f3baa9e88cb031225bfe4abaeafb"
		)
	]
)