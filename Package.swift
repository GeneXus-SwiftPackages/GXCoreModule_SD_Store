...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.5.0-beta.2.xcframework.zip",
			checksum: "515b46cb8da6028a6d9fba1cc81d294d72cebfc8d442d8f0da245f2c8e219250"
		)
	]
)