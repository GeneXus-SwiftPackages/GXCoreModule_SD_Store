...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.4.0-beta.3.xcframework.zip",
			checksum: "e38289ebee191bce7f75a4807c2becb33cf905b33c119d10bfbe38c0e27c6ed4"
		)
	]
)