...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230309150554.xcframework.zip",
			checksum: "91d4378b91915da2f3fc0a54c6c9edf5efdb79a7185e00c235deec88397eef3a"
		)
	]
)