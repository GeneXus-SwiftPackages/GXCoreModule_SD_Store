...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.0.0-beta.32.xcframework.zip",
			checksum: "e990172b2f6f01f1a25a83a7f6d14aee5e30172627089563d80cff4e610e0f62"
		)
	]
)