...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.1.0-beta.13.xcframework.zip",
			checksum: "d17ccd2d08161f5ca6cec4d726db9a7052ea61ad304179ee855d7648e7386e7f"
		)
	]
)