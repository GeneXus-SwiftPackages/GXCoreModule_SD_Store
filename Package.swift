...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-1.2.0-rc.36.xcframework.zip",
			checksum: "b4a7e46a94fab3288d1f41a063d168015417ba71f441e4d31ff0763fc00b700d"
		)
	]
)