...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230509173316.xcframework.zip",
			checksum: "8aabadc43ebc2b9d287b648d045adec9ee5b282d0dbdbaaf37526781ad1a9d90"
		)
	]
)