...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-1.2.0-rc.25.xcframework.zip",
			checksum: "1680df9fdc8b147afb5f9eca74341d3de8e3826ae5070e8aec44e6b4e7c63b25"
		)
	]
)