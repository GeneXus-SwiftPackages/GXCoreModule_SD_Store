...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-3.0.1.xcframework.zip",
			checksum: "e1f561dd5ec471c0e0f108b50d7d159eeaf0a4a4807927f995b289c8942190da"
		)
	]
)