...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.10.xcframework.zip",
			checksum: "7f87f36dc82cad1ca5fc6a4d75117c527f814fda261144d3e3ce818d81af83db"
		)
	]
)