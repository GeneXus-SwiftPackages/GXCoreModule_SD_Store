...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230411173940.xcframework.zip",
			checksum: "da0f3ef5dd4fcbf32d08c15109b06a761fa747997d6bb64af7a459abdd731226"
		)
	]
)