...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-4.1.0-rc.14.xcframework.zip",
			checksum: "ca1fcf7bc3e15efe274a1ab3520c21ba9137c542ce401d4567938754a1280daa"
		)
	]
)