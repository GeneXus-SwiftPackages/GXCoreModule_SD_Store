...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-3.0.0-rc.15.xcframework.zip",
			checksum: "709ef83e2e05cf0d79f76516bb2edae342645ef1c98f1f47ea882b7bf7fa811e"
		)
	]
)