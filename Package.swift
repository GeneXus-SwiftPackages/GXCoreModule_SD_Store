...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.4.0-beta.18.xcframework.zip",
			checksum: "a1f9fdc883d50002700c6d069ee50a3c9c56490f993e62c4bc5b85fae8f78cb5"
		)
	]
)