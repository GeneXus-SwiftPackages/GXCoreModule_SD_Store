...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.2.0-beta.10.xcframework.zip",
			checksum: "a889d0b84a9663eae1544c95c8d371fa651c06422a2cbdd8290c1b20289a12e5"
		)
	]
)