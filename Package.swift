...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.1.0-beta.14.xcframework.zip",
			checksum: "5aa2b15f45b6b370e5885f52295e437ba66ba798bb7ca0fd2e16d56430957a53"
		)
	]
)