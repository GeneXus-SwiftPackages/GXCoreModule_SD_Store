...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.6.0-beta.4.xcframework.zip",
			checksum: "dfd3b5abd1c0b22b0e4fbb36e17b0d98482226048778aa91e9d50adda5b4cfb4"
		)
	]
)