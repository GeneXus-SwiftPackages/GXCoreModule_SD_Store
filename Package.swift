...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.2.0-beta.7.xcframework.zip",
			checksum: "a4db7b7a1884f397d8134c600276ad8447a33ee45cb4052d39adcaccbd0bdb63"
		)
	]
)