...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.0.0-beta.2.xcframework.zip",
			checksum: "1c3efad33b7a76256730635944ddcffc6055f0a34182a19236f0874487e92f8b"
		)
	]
)