...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.0.0-beta.20.xcframework.zip",
			checksum: "e6edf303185fd092268576e99cfa1e5602b2d1acc0e5bd2032cfe2257bd6f2bd"
		)
	]
)