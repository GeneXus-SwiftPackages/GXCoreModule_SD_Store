...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.22.xcframework.zip",
			checksum: "653ddafaae2ec5c8db28443197c08438b5685a104010b65cb931ccdc3f2ec834"
		)
	]
)