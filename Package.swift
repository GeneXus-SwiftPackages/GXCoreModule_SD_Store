...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.0.0-beta.15.xcframework.zip",
			checksum: "9a0fbac2b3745d6ca222ddbd538730180e9cf145c17d13a350c488ea94106b32"
		)
	]
)