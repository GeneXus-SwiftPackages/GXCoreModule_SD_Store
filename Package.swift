...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-1.3.0.xcframework.zip",
			checksum: "8383d5a3f7287f04af6987baca7267da6701132445a0a808b0a6fc94e990a0db"
		)
	]
)