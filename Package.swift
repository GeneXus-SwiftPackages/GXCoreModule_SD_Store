...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta.20230706155940.xcframework.zip",
			checksum: "954b6593a0d12cbca71e563cace3dff50d47415143ee402f4db9f99f6a9301ae"
		)
	]
)