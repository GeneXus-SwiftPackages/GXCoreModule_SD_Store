...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.2.0-beta.1.xcframework.zip",
			checksum: "1fa1c60eab035140b51fa9e0463ec3362f93218b8c5330bb65a923f5500830ba"
		)
	]
)