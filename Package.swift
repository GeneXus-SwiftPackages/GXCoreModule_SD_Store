...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.13.xcframework.zip",
			checksum: "e70b86c181719430605b48907e8ff7d91026d632f4ef59e5300e25cb3e8f70c3"
		)
	]
)