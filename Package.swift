...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.3.0-beta.9.xcframework.zip",
			checksum: "cb2ae83090c9988894179c3dcca26c85351d9b0caf0c9f7a1508e8bfb116e178"
		)
	]
)