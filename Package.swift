...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.5.0-beta.8.xcframework.zip",
			checksum: "7030f802ed9b948ee3899ce37553699d184628718ab836e39f4aee27bb4532eb"
		)
	]
)