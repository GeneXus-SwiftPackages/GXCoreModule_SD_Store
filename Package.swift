...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-4.0.4.xcframework.zip",
			checksum: "c96d2e416eea22913c37a01b9581c8e1349b679b4660b214fddadab6e1ff85e7"
		)
	]
)