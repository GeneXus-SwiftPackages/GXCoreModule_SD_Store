...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230228111720.xcframework.zip",
			checksum: "6b93808d09c2846028483c5dc47e7bf53a7a344906816c701768f0c3d82c99e2"
		)
	]
)