...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta.20230701000831.xcframework.zip",
			checksum: "a8420802255bd05cd0a2a8ba5882b385bf277e58c5bfe241c7028cde4163cf75"
		)
	]
)