...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.41.xcframework.zip",
			checksum: "434a80374d61a373020006c9df7446129d03eab464d99e59a3588f24bf0fb383"
		)
	]
)