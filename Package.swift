...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.2.0-beta.26.xcframework.zip",
			checksum: "7056805c82b8c7893caacdb84a405a75c37de3623d6c6d8b20adeb18e51b6ae9"
		)
	]
)