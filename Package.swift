...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-1.3.0-rc.13.xcframework.zip",
			checksum: "cff7a99490c5ede8f33d19ccec539f008305cfed10d71085950fe50377f2747f"
		)
	]
)