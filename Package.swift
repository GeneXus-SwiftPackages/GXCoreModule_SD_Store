...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.0.0-beta.45.xcframework.zip",
			checksum: "2952fc16da00618f509f5172257e9a5bc7d8cbeae94897aeb925e7a99a0ba665"
		)
	]
)