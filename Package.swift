...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.1.0-beta.24.xcframework.zip",
			checksum: "e3497c1fec082c6d8448deea16c7800b23d6156b24be64f4723ab33fd1aee760"
		)
	]
)