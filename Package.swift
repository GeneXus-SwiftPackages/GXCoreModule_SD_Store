...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230525122919.xcframework.zip",
			checksum: "3d32fa3a43833755294fd179ad986b96cfd7194831eaebed70c420f13c30fb2f"
		)
	]
)