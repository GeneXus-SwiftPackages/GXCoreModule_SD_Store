...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.4.0-beta.12.xcframework.zip",
			checksum: "d3a00a941a40b39869cc4bcd82d20d17de45ee642adcaca7ecea24263b883122"
		)
	]
)