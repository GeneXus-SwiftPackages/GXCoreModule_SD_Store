...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.1.0-beta.15.xcframework.zip",
			checksum: "3ac76c9ec617c8b29c3f5dea8223a504f3d85e35b9b173da81157f9fc958e97e"
		)
	]
)