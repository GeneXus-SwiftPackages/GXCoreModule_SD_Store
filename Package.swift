...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.0.0-beta.34.xcframework.zip",
			checksum: "05c34fbe90a1f8b8b6e5c274b459d862b42f4062ea6c2a14117cca8b4cff9cdc"
		)
	]
)