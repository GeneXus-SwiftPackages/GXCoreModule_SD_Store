...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.21.xcframework.zip",
			checksum: "9e6d0981a84bae9ccde7b598c76aef988f3cbde9dd398016eaf89ae5c431a662"
		)
	]
)