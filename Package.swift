...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.2.0-beta.11.xcframework.zip",
			checksum: "737f032bf116cfb6c4de48c6b46759505bba9df80e376b82f831d822170d6691"
		)
	]
)