...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230502131235.xcframework.zip",
			checksum: "c6b779266bdfc241de888f1f95993ec8549fa276dd0c3b241ac32b0346e3dc18"
		)
	]
)