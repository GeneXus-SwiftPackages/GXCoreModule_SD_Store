...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.1.0-beta.8.xcframework.zip",
			checksum: "00544c8ec54a61f29882c160f5789e3c7bb3d473cbc27decf704904e6e0469dc"
		)
	]
)