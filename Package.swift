...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230428131619.xcframework.zip",
			checksum: "91e7b4a52a1691b6355169c4049787467879c5ce1c32c0f4114eb47dbb257f11"
		)
	]
)