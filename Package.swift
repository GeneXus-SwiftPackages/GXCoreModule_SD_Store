...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.2.0-beta.8.xcframework.zip",
			checksum: "08f09085b35061b2aa1e16945fc8c8335728f0c1491cd7abe7f92a3700f52351"
		)
	]
)