...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta.20230711133237.xcframework.zip",
			checksum: "cbb431add47a444d6c70bafa9a11f6384b4f50bb4108f863243a35b5cade656a"
		)
	]
)