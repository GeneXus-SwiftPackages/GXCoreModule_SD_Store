...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.0.0-beta.0.xcframework.zip",
			checksum: "8217f72224890aac3e3787390184b61dbf46f078bf2bb531f06f50c1d1e621d6"
		)
	]
)