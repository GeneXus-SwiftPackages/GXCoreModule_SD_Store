...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.5.0-beta.25.xcframework.zip",
			checksum: "74e106de82a0d5bcb9e5f47b6e6dfa1846b7639e55a4f60e2cd34508ded8025c"
		)
	]
)