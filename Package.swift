...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.1.0-beta.9.xcframework.zip",
			checksum: "3da156445bdccaea2e5d72c22192b3c7cc1ccc9750a5cf240e5469de6fb2981f"
		)
	]
)