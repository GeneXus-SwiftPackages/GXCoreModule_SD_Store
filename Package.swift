...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.1.0-beta.11.xcframework.zip",
			checksum: "6fe493054a593b7a444a9c277443aee1cb34b52b55af2c6c56c686d41ce24162"
		)
	]
)