...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.1.0-beta.21.xcframework.zip",
			checksum: "3cd313fa5218b85dbbd67f344b64d8e8a2cf79c12169e7019e9eae0840a11acc"
		)
	]
)