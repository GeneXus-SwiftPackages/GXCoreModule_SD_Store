...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.1.0-beta.12.xcframework.zip",
			checksum: "7299418ab6b4d1ce4e9256681821aed03279464e024b502e143073ce9d421ff6"
		)
	]
)