...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-4.1.2.xcframework.zip",
			checksum: "27d1b0050a4407c01bb9bb4bac15f752d38bf656aa11c5f7fa415d0d8b77b054"
		)
	]
)