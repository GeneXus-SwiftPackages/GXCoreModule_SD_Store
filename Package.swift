...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230306150353.xcframework.zip",
			checksum: "afbf3431086635d8c335b6cb1e33c62e2730e207a1231456d80e8f238dfdc4df"
		)
	]
)