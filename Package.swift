...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.1.0-beta.15.xcframework.zip",
			checksum: "b3139631d524936ca897321cac5da20904a0ab0386ad6aa696fad24c8c0c2dd7"
		)
	]
)