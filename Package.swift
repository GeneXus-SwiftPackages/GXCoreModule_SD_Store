...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.4.0-beta.16.xcframework.zip",
			checksum: "0ff346438ef5362e6ca61f07d488d827edbf1c16e0a2f45cf2f445ffa981eb5c"
		)
	]
)