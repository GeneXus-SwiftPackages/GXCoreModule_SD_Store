...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.1.0-beta.25.xcframework.zip",
			checksum: "7a084c1e9753c75d4dafd503219b20575d9a89d83769aca2ca3f9f983a794487"
		)
	]
)