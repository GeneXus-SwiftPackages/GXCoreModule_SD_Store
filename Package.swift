...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.2.0-beta.15.xcframework.zip",
			checksum: "3c8cdeca4be991df84df2ec7727232eeefe983f3708ca09736ff0502653348dc"
		)
	]
)