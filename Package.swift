...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta.20230724135409.xcframework.zip",
			checksum: "639bd5df7b9563e02fb5cbc94d58b2f572fd61a4eb2366f202733d5f709249d6"
		)
	]
)