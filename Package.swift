...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-3.1.5.xcframework.zip",
			checksum: "4c4af80b2596cfca94d06755876f9419b075000d6d88d412307a8599f68d17a7"
		)
	]
)