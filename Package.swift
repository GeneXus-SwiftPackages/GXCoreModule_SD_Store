...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.4.0-beta.2.xcframework.zip",
			checksum: "28ba4c76c0d404a143ab86c0ab442ca32d2327d99533305508e4645068b9dc8d"
		)
	]
)