...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-2.0.12.xcframework.zip",
			checksum: "d3d8b4da6575d1b00dbc988c9bee5865f716a3afa820f41f0d01b3b6862dc966"
		)
	]
)