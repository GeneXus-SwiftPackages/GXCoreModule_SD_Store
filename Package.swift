...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.2.0-beta.28.xcframework.zip",
			checksum: "641f12f2beb21c4672655876f1cbe79d166fe427e4a387d33b951de5dc005d9f"
		)
	]
)