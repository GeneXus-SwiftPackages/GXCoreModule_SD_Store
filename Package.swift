...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.1.0-beta.4.xcframework.zip",
			checksum: "9a7eef9b8a7338b4e3cc6780c51626817b4cc7e8f658fc0fec91a6a148c5f315"
		)
	]
)