...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-3.0.0.xcframework.zip",
			checksum: "8fc0dacaf31049c5f3742f4addc9c247cc682edda0de4403240fe8a6445c4b13"
		)
	]
)