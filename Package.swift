...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-1.2.2.xcframework.zip",
			checksum: "cbdb51dc1eb3ae265122498815fdd73ad5299ee851b21314b332075c84b315ad"
		)
	]
)