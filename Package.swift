...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.19.xcframework.zip",
			checksum: "3f9888d5818c3d196dfdcd57d2e42b93527e2edee4d1c0ec44798b547dd126d0"
		)
	]
)