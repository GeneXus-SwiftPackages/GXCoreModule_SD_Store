...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.4.0-beta.4.xcframework.zip",
			checksum: "734eddac32f5b1b1eb3f972f28ed6fb260ab0748b6f2d0c32a5cfe259d940fb2"
		)
	]
)