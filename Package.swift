...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.37.xcframework.zip",
			checksum: "fa794f1bddce3532f1e3330e009fd4f20938316eb13e41739aa8aa769ca10387"
		)
	]
)