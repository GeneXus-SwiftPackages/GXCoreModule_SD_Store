...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.0.0-beta.49.xcframework.zip",
			checksum: "5240c0a53fdac2e3d4632dbae5c5072b6c030ac81ff475da23a97179bd9e7877"
		)
	]
)