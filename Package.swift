...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.1.0-beta.22.xcframework.zip",
			checksum: "d1309f47ad498756b8bb6b1aeec60e8054145de53c22e655af303c39326db07c"
		)
	]
)