...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-3.0.7.xcframework.zip",
			checksum: "fb8926822b8a8a7ba7d7fb0903542f4bb4058c1358d00bab8f6ff5dfa9e986dd"
		)
	]
)