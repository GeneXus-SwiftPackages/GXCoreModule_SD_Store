...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.36.xcframework.zip",
			checksum: "758dbc13bbebd4b14b8ac0f993f843723b9939d0cbd3eb6436a7cef5b02ee94c"
		)
	]
)