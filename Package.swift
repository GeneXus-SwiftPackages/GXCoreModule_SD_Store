...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.2.0-beta.29.xcframework.zip",
			checksum: "a3c565b79b2cf963a8ec579d724ea85a5e3fd5a8058894dd8ed176487a56d8b6"
		)
	]
)