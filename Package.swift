...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.1.0-beta.17.xcframework.zip",
			checksum: "09689c735a14afdcfc5ef1b7abcb16d7dfdcf0bc18a133b673dd76053b9a765d"
		)
	]
)