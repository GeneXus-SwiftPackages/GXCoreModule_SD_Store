...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-4.0.17.xcframework.zip",
			checksum: "28546d230a06855c68f7900423a3fbdac1c3435a083e95472f51ac4b9e68f321"
		)
	]
)