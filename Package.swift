...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.33.xcframework.zip",
			checksum: "ce11c2db83715ad1356ffff7eb46134572b6e964bcc46ed8b957175a36de2ac7"
		)
	]
)