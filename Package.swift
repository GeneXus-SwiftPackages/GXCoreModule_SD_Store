...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-3.2.0-rc.12.xcframework.zip",
			checksum: "4c3a293361d86884eadc0b08b20522e074a1d9514240e2f226020518350e5865"
		)
	]
)