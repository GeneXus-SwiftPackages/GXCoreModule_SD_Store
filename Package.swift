...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.2.0-beta.22.xcframework.zip",
			checksum: "cc60dd72adf98539c8da75975601d53b0b25cf926787e0816fa9416ebea57f6e"
		)
	]
)