...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-2.2.0-rc.1.xcframework.zip",
			checksum: "4caf251f460a7625cff296f06ffc2e3d23f9a958f6f3d805f4c669191fbbb31d"
		)
	]
)