...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-1.5.0-rc.2.xcframework.zip",
			checksum: "517ecce0dfe9239aece2e233e4e9fc408fc3ec7848c02b3437d68d16cb3d828b"
		)
	]
)