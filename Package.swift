...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230509112137.xcframework.zip",
			checksum: "929ea802ae9ff8d89b88cec4df6df8730517b13fd03a07ef49b21f02c569cdd5"
		)
	]
)