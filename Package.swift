...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.2.0-beta.23.xcframework.zip",
			checksum: "3d60b9add874abfc84e1ff5aecd8ae32b493845b387c0df300ba94170cdac764"
		)
	]
)