...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-4.2.0-rc.0.xcframework.zip",
			checksum: "a51410dc6dfbc32c54c59aa5e2f9aec9628cc205f4be755961ca7ad0cc371a7d"
		)
	]
)