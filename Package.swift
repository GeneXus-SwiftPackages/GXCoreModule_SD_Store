...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.5.0-beta.7.xcframework.zip",
			checksum: "c4bd89389768432b37fbff64c6828ccb553bd5627b8d2eb57cf0f67b29b73bc8"
		)
	]
)