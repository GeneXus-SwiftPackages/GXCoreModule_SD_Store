...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.1.0-beta.10.xcframework.zip",
			checksum: "aaac2345be58654e5a06b0560b0bc7c78bcfc353da2bd6cd84a8ff4bacd115c7"
		)
	]
)