...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.28.xcframework.zip",
			checksum: "a93ad6cdb51b89396f612393647e8b4395b4dc140b9752d13b322034fb4be759"
		)
	]
)