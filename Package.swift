...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.0.0-beta.47.xcframework.zip",
			checksum: "4e948a09b3ed7ae73f7479ad32ad2df457fcb0f336b2d0a6415c0368d3267529"
		)
	]
)