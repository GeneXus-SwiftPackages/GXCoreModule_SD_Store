...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-1.4.0-rc.1.xcframework.zip",
			checksum: "fe11876ff8ffdf0b7ef7ae482f9e1c1a3842e1ca74852a116750dbd17ee748ea"
		)
	]
)