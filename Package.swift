...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.3.0-beta.4.xcframework.zip",
			checksum: "3f945071018c74987dd2f5d3642e84397a0c2f26e08e63fadc7af176557355a8"
		)
	]
)