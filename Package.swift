...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta.20230717172207.xcframework.zip",
			checksum: "a8df24a27aa66b9ee7c9aae463fc9cb6e88e6897e2f7869462f3c451788f63c9"
		)
	]
)