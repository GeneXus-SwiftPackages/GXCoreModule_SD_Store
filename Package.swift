...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.0.0-beta.44.xcframework.zip",
			checksum: "3b1ac32daa4323e96d5f28c08d4a5cd87830865fa49a95a01d68d418d7b023d5"
		)
	]
)