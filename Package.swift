...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-4.1.0-rc.8.xcframework.zip",
			checksum: "1be50b6349230ed4a431ba64dac9a26bbfeb75d570f69a21f2da815bd8af79fa"
		)
	]
)