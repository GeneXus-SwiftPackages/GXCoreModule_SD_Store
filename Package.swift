...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-1.2.0-rc.15.xcframework.zip",
			checksum: "fc4cbbf5e6ee29acb8657e3d1031e071cb1d14d16f7f6b3601ff9e8ec4635251"
		)
	]
)