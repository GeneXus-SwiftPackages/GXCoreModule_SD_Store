...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-4.0.0.xcframework.zip",
			checksum: "be0f43b964deec2a9dad7bcc7be3d3f976eae89db139a3bdcec039ce7331b4d5"
		)
	]
)