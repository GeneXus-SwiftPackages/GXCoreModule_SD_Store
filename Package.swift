...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-4.2.0-rc.34.xcframework.zip",
			checksum: "10059ad308b83554431375e2ef933f4c37bfc903625b5b26d02decc7eda439b0"
		)
	]
)