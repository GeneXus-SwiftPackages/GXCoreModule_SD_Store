...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.2.0-beta.10.xcframework.zip",
			checksum: "e2fd94197909ab8a225b96b6777a56c35affc38de3f271c5afc046aa18cc3869"
		)
	]
)