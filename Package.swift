...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.2.0-beta.11.xcframework.zip",
			checksum: "341a38ec865b5627c763c749aa1e9480654a30d3413c84a811429d7a07e0ff26"
		)
	]
)