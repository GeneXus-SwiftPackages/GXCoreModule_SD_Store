...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta.20230721123914.xcframework.zip",
			checksum: "3f666d080c89fe206056f984e318c7ff19d2a347cca1f7dd47220d9e521f91f7"
		)
	]
)