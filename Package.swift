...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-3.2.0.xcframework.zip",
			checksum: "8bd5ec9ae8d9478f5f046085841a1804b9cf19500070a391d60e5e247980c2b6"
		)
	]
)