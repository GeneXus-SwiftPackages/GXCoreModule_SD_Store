...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-1.5.17.xcframework.zip",
			checksum: "82ee40397cb485ddf287669183b683411d2c51b7a0cb1b26e8173909678f032b"
		)
	]
)