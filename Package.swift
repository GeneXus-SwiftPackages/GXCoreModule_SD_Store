...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230414101841.xcframework.zip",
			checksum: "fcbaff9dbf028e2e1f710cf813a21ec69dbfa6f66ffa0a233e0f8fb3b5fdc27a"
		)
	]
)