...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230328171001.xcframework.zip",
			checksum: "965e4826b1f9fa1144c7877e85999f7d29f7d284853d216272ef9ef82c93730d"
		)
	]
)