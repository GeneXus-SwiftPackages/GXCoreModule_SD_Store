...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-1.6.0-rc.0.xcframework.zip",
			checksum: "424fc51b328369dbffe6bde28bb948900eded1ff31fa8327d47974647ccd5d95"
		)
	]
)