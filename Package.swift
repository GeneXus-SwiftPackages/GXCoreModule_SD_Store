...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.0.0-beta.22.xcframework.zip",
			checksum: "95b917023013b398e5830a4ef87af4a6ca87b568e4769e0c67bf4162ca62a1ad"
		)
	]
)