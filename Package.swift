...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.2.0-beta.19.xcframework.zip",
			checksum: "4e66f55dd41110b899902a8c0a48b4120953ef802d4471b11b706d66e31652f1"
		)
	]
)