...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.2.0-beta.24.xcframework.zip",
			checksum: "ceff2b76c784c38859c9531f3aea28b72ea5c327d6da80ef7748720371b55847"
		)
	]
)