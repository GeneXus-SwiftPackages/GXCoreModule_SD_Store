...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.5.0-beta.16.xcframework.zip",
			checksum: "21fa5560961e4e06933bb6467af00fb946748c4028808ccb9f704149db6cc71a"
		)
	]
)