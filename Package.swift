...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.0.0-beta.10.xcframework.zip",
			checksum: "0a718b2e0239ffd8a75013d82e96448fc58e3cdb20d7970815e4135424e5059a"
		)
	]
)