...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230519182256.xcframework.zip",
			checksum: "7cd5e224e68d67a070a5988a7734dbeb24297d814cdf5c8abd2af5f744c9e28c"
		)
	]
)