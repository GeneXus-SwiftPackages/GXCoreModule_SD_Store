...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta.20230623154354.xcframework.zip",
			checksum: "487b9802d6e0c7f9bade401d7b1babbd2832697233c0228476e87767419528b0"
		)
	]
)