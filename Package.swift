...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.12.xcframework.zip",
			checksum: "74989f8b0e5e53f8937529602c6ba5a2ccb339bc4e0976e72924f7a6e8d975f6"
		)
	]
)