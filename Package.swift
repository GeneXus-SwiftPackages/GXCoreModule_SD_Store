...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-1.1.0-rc.5.xcframework.zip",
			checksum: "878a3a20c02e454a161817738986d69d2bdea3038c147f4133652b17d3d0c48e"
		)
	]
)