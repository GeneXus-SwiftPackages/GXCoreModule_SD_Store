...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta.20230726144822.xcframework.zip",
			checksum: "63aee7982377e855e624c76d69bf0e67d2a07b92d3fa5d0f7c95e73b5d3c10b1"
		)
	]
)