...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230315133647.xcframework.zip",
			checksum: "49256aec8fb00cb4c5dc6897608be671659ad1ea8535fc6f020dae70befac4df"
		)
	]
)