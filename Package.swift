...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-3.2.0-rc.11.xcframework.zip",
			checksum: "623019d346089c18ca262cb178ace5cdbf996cefd0a49e2f8d089a4749a9beef"
		)
	]
)