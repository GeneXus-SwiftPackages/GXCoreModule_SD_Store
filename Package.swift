...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-2.0.18.xcframework.zip",
			checksum: "7b534f92905e0a631bab7f35d175c0bd2f67163d784a917c461b579935637d73"
		)
	]
)