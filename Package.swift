...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230531050040.xcframework.zip",
			checksum: "1a3a9a81470d7d8e2af2296d79bfd285707841f75fcc26b40d443073fb96f445"
		)
	]
)