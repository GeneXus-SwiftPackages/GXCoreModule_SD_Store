...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.0.0-beta.17.xcframework.zip",
			checksum: "ee6bf94e9b6474d27b04717d9f201578c5900968d97603c662b34d9762e5dd95"
		)
	]
)