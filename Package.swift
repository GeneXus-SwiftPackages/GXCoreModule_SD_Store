...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.5.0-beta.27.xcframework.zip",
			checksum: "dcdd1990f11c428bbd5b3b8426d6205109e0146aa5ffc2d4c7ba74d8c23c8f75"
		)
	]
)