...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.0.0-beta.21.xcframework.zip",
			checksum: "04c7b46f63e3b95c77c6859e29ed4afa6109f7b2706427d85577bcaaa712d3c3"
		)
	]
)