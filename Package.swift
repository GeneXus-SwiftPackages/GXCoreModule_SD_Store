...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-4.0.2.xcframework.zip",
			checksum: "13303222996227d5338301183281ebf197198e7008354deac3e0fb158b918639"
		)
	]
)