...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.1.0-beta.31.xcframework.zip",
			checksum: "cb60459ffc9e09985b6a331c26c92c52638f4fffb8d9e69f762bfdd077bf47ba"
		)
	]
)