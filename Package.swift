...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-4.0.5.xcframework.zip",
			checksum: "11ec0d2aaeba5681060978099ec8802b1e9b04c8dfecb8dafff43b69396146d2"
		)
	]
)