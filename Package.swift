...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230505132240.xcframework.zip",
			checksum: "778d250f21285cd4ecb704ff1c041e7a1b5ff062fe1280be3fcc280f22f7fbd8"
		)
	]
)