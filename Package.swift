...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230428153652.xcframework.zip",
			checksum: "219ba5a49b2d3a74f22e6d857b7905d93f7039beff4979250e7509b1acc4443f"
		)
	]
)