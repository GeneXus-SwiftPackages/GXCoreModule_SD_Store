...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-1.4.30.xcframework.zip",
			checksum: "061eeb5028e67c6a1e9fc116b7f58af0bdeee402ba480d95d83e188718098e90"
		)
	]
)