...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.1.0-beta.2.xcframework.zip",
			checksum: "270e915ec9f007b2b4c7bcda647174d4e3c42a9554c1bd590f50d59360407427"
		)
	]
)