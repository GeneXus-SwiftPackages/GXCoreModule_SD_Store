...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.5.0-beta.4.xcframework.zip",
			checksum: "154ecc6e96c869c72836a13f412bdf3b3256465c7d88acba00608896cdd3c0aa"
		)
	]
)