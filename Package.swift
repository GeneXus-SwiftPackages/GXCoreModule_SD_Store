...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.40.xcframework.zip",
			checksum: "57bee7473e1f07ce0f5c2ab1db62b6483e03d6f2b62914b464bcf4873319a537"
		)
	]
)