...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.2.0-beta.7.xcframework.zip",
			checksum: "1179d2ed81f1fb81f08240534f654b65b1df79d108a9408a54f0bd8a6a4e7780"
		)
	]
)