...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.5.0-beta.26.xcframework.zip",
			checksum: "70c85e4e6e5e0e20bb33fcbe8a2e3d3a805b54886b136f268a7fa352754cbc3a"
		)
	]
)