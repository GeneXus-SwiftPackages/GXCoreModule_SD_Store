...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.0.0-beta.35.xcframework.zip",
			checksum: "e760b732eb819b2e46b4ba6ff00254b48ab13771b78b5cb46e6fa923c864690e"
		)
	]
)