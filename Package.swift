...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.0.0-beta.16.xcframework.zip",
			checksum: "bf8ba33223e041649b473e8e5e2b3140f3ad6a88a358e6c5be64ab5551533c5a"
		)
	]
)