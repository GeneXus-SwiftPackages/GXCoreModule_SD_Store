...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta.20230704132152.xcframework.zip",
			checksum: "44cf1f37f5d0996b131d42c1155b33c4c78aa0f51373fa03af9e7a9555342789"
		)
	]
)