...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.2.0-beta.29.xcframework.zip",
			checksum: "73efe3a9eced42167b1a8f63e3c4297c750d3b183e3a65f64dbb65e38d773c7f"
		)
	]
)