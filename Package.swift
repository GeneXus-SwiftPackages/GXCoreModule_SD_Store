...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.1.0-beta.23.xcframework.zip",
			checksum: "d1f63cb129d86d3ee9e523bfcf8dd41d0e900a2ca11cb810dda4810c6f01cc93"
		)
	]
)