...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta.20230613192339.xcframework.zip",
			checksum: "47bb2cb6178c801557440757680349f311f187c3805038286ef6df06807738a4"
		)
	]
)