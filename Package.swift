...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-4.2.0-rc.20.xcframework.zip",
			checksum: "2e198955408308b1a878609df1f3f29cac127baf3af7f00c80784e4723eead72"
		)
	]
)