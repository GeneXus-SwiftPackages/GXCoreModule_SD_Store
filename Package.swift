...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230605162159.xcframework.zip",
			checksum: "7f0c84d8ef61f2ce398899f6b4c4b5603c610bff9de0f96f49d6331894c45e40"
		)
	]
)