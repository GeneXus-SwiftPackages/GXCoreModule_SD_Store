...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.1.0-beta.16.xcframework.zip",
			checksum: "7d8b95c026dc5e765555190c3f6ab02c7a972f9bd0d56fdbe01f4277d2fcf71e"
		)
	]
)