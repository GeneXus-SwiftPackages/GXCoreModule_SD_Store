...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.2.0-beta.20.xcframework.zip",
			checksum: "7ec2f09dfcd13b44fbd57d7a99c61c1e26a204fca891b47cf7085bff4be6ff71"
		)
	]
)