...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230515153434.xcframework.zip",
			checksum: "c07c0f76b4e47b3bf8479996eae6d5da13c8854f9bf73606fa2d3ee2b7efb2e1"
		)
	]
)