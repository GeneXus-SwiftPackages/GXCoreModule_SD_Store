...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230509202229.xcframework.zip",
			checksum: "f4267246253fd3638715cd7fe2e9d9eb06290b56886ef0c9e48d57ba3bc90e04"
		)
	]
)