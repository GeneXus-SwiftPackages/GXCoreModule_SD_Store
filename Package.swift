...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.2.0-beta.36.xcframework.zip",
			checksum: "45358b901384e749896fd3d08f27a55c2f1c2df840bd678ab17a0dbb8a999a8e"
		)
	]
)