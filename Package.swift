...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.2.0-beta.23.xcframework.zip",
			checksum: "2bad1c0217ba6e4a74149ded573079916dcda12f79c76b7b91ba39bed698432f"
		)
	]
)