...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.2.0-beta.1.xcframework.zip",
			checksum: "b9daa71066fecdf22ca9e20d5dc632d5538ece47f192ca2a3741f54601661a0b"
		)
	]
)