...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-4.0.9.xcframework.zip",
			checksum: "6af92f682efc3344bfa56dac9e7091b38a859fce3539bd5ef4b225575a3be258"
		)
	]
)