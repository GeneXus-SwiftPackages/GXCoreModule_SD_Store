...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-5.0.0-beta.4.xcframework.zip",
			checksum: "d63bf4ccf86d878fb801cb424964c3e5a81d60825ba60c581468dd43f6495693"
		)
	]
)