...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-1.3.3.xcframework.zip",
			checksum: "3b4135d19d131417c0f91b7976ab53947d1d5d43b17e1f73285c6241f691ceae"
		)
	]
)