...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.25.xcframework.zip",
			checksum: "6fece8ff9c503feb1f3db7eac26a7a91b4c3e724dcf4e4b3f9474d6fbcb7ca43"
		)
	]
)