...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.5.0-beta.5.xcframework.zip",
			checksum: "af1176ffd7d7dd7504472d431578bba3c7041453e8a7804ee0726d9275b13ae3"
		)
	]
)