...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-4.1.0-rc.3.xcframework.zip",
			checksum: "7e8f5c3c182cc75c2383e9c17afde836ddff4c8b9cf36cefbde3c4df60dcc517"
		)
	]
)