...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230516174834.xcframework.zip",
			checksum: "051c822a961bb8d2381456437b2426b15ba6cae77d3b36455e63bc1caacb6f64"
		)
	]
)