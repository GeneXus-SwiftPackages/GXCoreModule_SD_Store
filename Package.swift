...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.0.0-beta.41.xcframework.zip",
			checksum: "441900b10693449a33ae38d17679e9c2aad1243b92a142cbccc52b0d1c770dc9"
		)
	]
)