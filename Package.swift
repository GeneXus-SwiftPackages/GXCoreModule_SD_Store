...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.5.0-beta.19.xcframework.zip",
			checksum: "812098cd3ccea538915cee03f021cb92622d6bdac70f4324adf7d17ce3d18131"
		)
	]
)