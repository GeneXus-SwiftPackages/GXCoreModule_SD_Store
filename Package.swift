...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.0.0-beta.51.xcframework.zip",
			checksum: "3696effed1cba888a8d4c279e1db79ebd45efe98793f89ded68df1e37f741dcc"
		)
	]
)