...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-1.4.0-rc.21.xcframework.zip",
			checksum: "058b704dc91323c760142b1a16cf6ed202a4267bc28fa3d769f8e5779a50b8bc"
		)
	]
)