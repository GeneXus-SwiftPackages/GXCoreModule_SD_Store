...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-1.4.0-rc.10.xcframework.zip",
			checksum: "88b7a3fc357e8002420c3b3683921e512d71b7514bcc48a0601fec2f0c5b274c"
		)
	]
)