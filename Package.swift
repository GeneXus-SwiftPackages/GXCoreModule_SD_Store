...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-3.0.3.xcframework.zip",
			checksum: "ec82d941cd610257ad7597d3827666911ee71911f76e2412b1ab8cba61cb4371"
		)
	]
)