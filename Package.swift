...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.1.0-beta.5.xcframework.zip",
			checksum: "43713e82ce981ee313fd4d97d1e20c221ac8238202bd54d3100ce9fd2d171716"
		)
	]
)