...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-1.2.1.xcframework.zip",
			checksum: "0b078daedfc1f0f87c064e161f4323f8f21a166dcba46991cd57263d4a1b873a"
		)
	]
)