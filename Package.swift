...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.1.0-beta.1.xcframework.zip",
			checksum: "672f063d237774cc1b28553c089a856f77cb7db2dfc1db948ce2a12d89804140"
		)
	]
)