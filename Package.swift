...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-4.0.0-rc.0.xcframework.zip",
			checksum: "fd7edc38878ae0d6c2d44cb40bb1ab8319ea99a94fd25791eeded42b30897d4d"
		)
	]
)