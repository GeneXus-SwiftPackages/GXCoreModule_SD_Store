...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230324153906.xcframework.zip",
			checksum: "25bf2b1b7d249186c45533ab337ad683a1de92a73a85219f1ab4b2d7ec48c663"
		)
	]
)