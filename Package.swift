...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.5.0-beta.9.xcframework.zip",
			checksum: "35336e7d79857d5f867c4f339b2751196a462ca39550b5f6a9d444533452916c"
		)
	]
)