...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-1.3.0-rc.1.xcframework.zip",
			checksum: "568a5ada691fb13ecb87aed351deaedbbaa704bd1f20da7533bcda9ebc119e40"
		)
	]
)