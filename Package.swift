...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.1.0-beta.19.xcframework.zip",
			checksum: "b95905aa6ff7f5a5b5e1a91c1fa748edfaaa22b5edca4781b50f674c0b4f59c6"
		)
	]
)