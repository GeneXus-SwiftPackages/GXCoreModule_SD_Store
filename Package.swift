...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.4.0-beta.6.xcframework.zip",
			checksum: "f56c061efd3cd89a147183612b7622e7ee1952fbfec5d776f2592514d4891975"
		)
	]
)