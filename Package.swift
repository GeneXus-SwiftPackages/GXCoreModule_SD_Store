...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta.20230707201252.xcframework.zip",
			checksum: "d8d414f88484aef861f4011cfe219a6fa1eb4a02fa58eef61b89ef87b546d07b"
		)
	]
)