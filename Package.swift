...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.2.0-beta.14.xcframework.zip",
			checksum: "ff1086da40bf8651ed05ea3b96c500cade1d4b36b2fddafc681261a88b40da67"
		)
	]
)