...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta.20230630152236.xcframework.zip",
			checksum: "06ba1e06286820c2b3df9e5e544e11f4838a4d88c97591940fd0597d96aaafcb"
		)
	]
)