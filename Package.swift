...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.2.0-beta.25.xcframework.zip",
			checksum: "663d833b06661499a079180e27a31aa3fc12693787ba97f92b757f7ccd0619a0"
		)
	]
)