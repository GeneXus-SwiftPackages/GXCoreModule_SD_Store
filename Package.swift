...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.2.0-beta.17.xcframework.zip",
			checksum: "7414421503bd90dedfe0cec0a08dcbca7d2700136761ebb2b2cc5caf8fbc189d"
		)
	]
)