...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.1.0-beta.794.xcframework.zip",
			checksum: "b94896281b0675cf12b0b00ef02ebfc8fed5bc5d0858d489b85fee123e858074"
		)
	]
)