...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta.20230614190626.xcframework.zip",
			checksum: "b3dc081d1bdf99e72118cc989bddfb4e0066b180b038039177b6bf507e0e9d29"
		)
	]
)