...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-1.4.27.xcframework.zip",
			checksum: "68127464676b8318a0a44ca65d976ebcc2336fc97ac29f661aa3c13417bbec2c"
		)
	]
)