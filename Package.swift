...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-3.1.0.xcframework.zip",
			checksum: "b7c0e2f6cfa8db0dc015c0f4d89e2a2a3af32ad46fc3edb688446c689b1b8337"
		)
	]
)