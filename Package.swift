...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.6.0-beta.2.xcframework.zip",
			checksum: "351543a4be1feff4c0dc4845460eb30858e380c43df6c07e530e3f5ce8243129"
		)
	]
)