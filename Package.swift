...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.34.xcframework.zip",
			checksum: "8011e6baca5a81dda927042ca64ab29bbb49dfca31e914f535e2d4c010d8f98a"
		)
	]
)