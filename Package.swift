...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-3.0.4.xcframework.zip",
			checksum: "bd96f62c178e18db7980154641e8dfe66b882cbe245e7a81429c7d49a1b7a4de"
		)
	]
)