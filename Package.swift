...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.0.0-beta.11.xcframework.zip",
			checksum: "4319199cb234cd2ee37016ff8973888c13b69804b3db16f482440e55ac5567da"
		)
	]
)