...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.6.0-beta.1.xcframework.zip",
			checksum: "01c0961baaaa1bc43f257fe38c4eff8c1eee06d513122d2a25fe7e83382acde8"
		)
	]
)