...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.1.0-beta.11.xcframework.zip",
			checksum: "7a3016796c3fcfc0c2bd93c85631f40668060d4e810310f74dde60740d34a69e"
		)
	]
)