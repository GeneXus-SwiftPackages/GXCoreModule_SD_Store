...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta.20230707153504.xcframework.zip",
			checksum: "137be9630203d09cea6dae8e20f11c085a5dc7719f2ff01dffdd8fcc806857a4"
		)
	]
)