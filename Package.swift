...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.1.0-beta.17.xcframework.zip",
			checksum: "ce84ed96982f001d659e07c5ba9e5cc949a294b0fbc341f1d83a3c3b50587e83"
		)
	]
)