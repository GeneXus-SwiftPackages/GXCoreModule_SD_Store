...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-1.3.6.xcframework.zip",
			checksum: "c1eb79228bb42a8f11bb60dff9e11c2821b878777fe6218a8ceb09445ab6e5d2"
		)
	]
)