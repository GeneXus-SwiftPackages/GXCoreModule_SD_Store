...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.2.0-beta.21.xcframework.zip",
			checksum: "a336978b1c7245bb710edbd5701e9a0c1b2ed8295b1dbee6526a2efa800d3855"
		)
	]
)