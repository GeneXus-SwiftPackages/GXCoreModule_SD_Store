...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.0.0-beta.30.xcframework.zip",
			checksum: "9e47ff6e44eb12375b215a5514aab3d1f55975020f5051e05139d5fa852bdb4b"
		)
	]
)