...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.3.0-beta.7.xcframework.zip",
			checksum: "908eec325c43d60e671256bd0936912298e8f1c3ddac31ac370f6fd8ad942751"
		)
	]
)