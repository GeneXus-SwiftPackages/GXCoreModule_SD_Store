...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.1.0-beta.9.xcframework.zip",
			checksum: "999cb916ddce764a77e995271319e841b468585137c4b440f9591fdb000dc1fe"
		)
	]
)