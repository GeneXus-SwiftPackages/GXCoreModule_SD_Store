...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.5.0-beta.3.xcframework.zip",
			checksum: "0a02a1ad51fe806ce6e1f65e2a2b50ee5ac467ef31f8ac241c011dca758406fc"
		)
	]
)