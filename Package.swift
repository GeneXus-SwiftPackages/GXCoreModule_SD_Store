...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.24.xcframework.zip",
			checksum: "2226ba2cea24754637eb1e89bbb8ce0a1d046025bc72595e2f4d28c27f568d18"
		)
	]
)