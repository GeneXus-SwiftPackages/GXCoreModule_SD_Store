...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.2.0-beta.20.xcframework.zip",
			checksum: "90cebbd9764d12f4905ce19faca13bc44ff62b045bb6be479f980b2eea757dfd"
		)
	]
)