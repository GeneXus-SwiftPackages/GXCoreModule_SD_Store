...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230309134517.xcframework.zip",
			checksum: "ea7f0eec1d38b537146eac8be2a25c49820f30f1dfe2a530e8cefc821668cebc"
		)
	]
)