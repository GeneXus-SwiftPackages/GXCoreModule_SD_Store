...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.5.0-beta.21.xcframework.zip",
			checksum: "e04c1133010d2743649d34820e7c0131de34e5bf9b2a58c6bb9f10fab817ba67"
		)
	]
)