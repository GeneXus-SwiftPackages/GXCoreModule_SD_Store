...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.1.0-beta.32.xcframework.zip",
			checksum: "a51aa19f3c74a08985ba513ffa52fd39b8c1b37b4b4470d8aab312d16a56528a"
		)
	]
)