...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.2.0-beta.11.xcframework.zip",
			checksum: "570a6425ac72469bb46ffb626626f9ff1aa9fa54ce9bf6e27175ee87e18e54c2"
		)
	]
)