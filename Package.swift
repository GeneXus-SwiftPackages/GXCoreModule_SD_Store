...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.1.0-beta.7.xcframework.zip",
			checksum: "ec3271536d0d4472d319da2a0efc7aa646698b49ed7ce071cb22684d5c9b99ca"
		)
	]
)