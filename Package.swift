...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230307184249.xcframework.zip",
			checksum: "71fc4335f97977582bd2c000f430fb30c8e143f0985a601020b484bf9ea03772"
		)
	]
)