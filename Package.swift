...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.2.0-beta.14.xcframework.zip",
			checksum: "c9953f76fd56eb575605b612fc41a5b10a5258548dd67c544ec3776d91f60574"
		)
	]
)