...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-4.1.1.xcframework.zip",
			checksum: "55da49f69e5dfe4a1c16d491c5416b928c74866a0ed2930a2eb03e6ffa444f95"
		)
	]
)