...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.1.0-beta.14.xcframework.zip",
			checksum: "d5efd9634ea16e5d63b5c8843ff1644c71ac9bc8cd22129aa420188167242d7c"
		)
	]
)