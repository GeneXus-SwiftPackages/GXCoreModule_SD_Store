...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.1.0-beta.23.xcframework.zip",
			checksum: "e9c01a9adc6793273c175d7db40293c490209ffe29e9075b2df385b630046195"
		)
	]
)