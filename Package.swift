...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230323132058.xcframework.zip",
			checksum: "d687930c003f359e6af796a41e80468af54b3c583d437ef36674f2b5b972a099"
		)
	]
)