...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-4.2.0-rc.3.xcframework.zip",
			checksum: "d2b73ebe60faaa2bdd1e2b922c00b71f2f87e8db904382d4f41fb7834df8c7b7"
		)
	]
)