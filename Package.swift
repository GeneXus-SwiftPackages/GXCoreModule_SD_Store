...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-3.0.0-rc.8.xcframework.zip",
			checksum: "0ba00bee3538f12c624cc22804b19dece61b937c1158456ab70e038b549913ba"
		)
	]
)