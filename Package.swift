...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.2.0-beta.18.xcframework.zip",
			checksum: "7ec8a3c4112f9da744e98e98f8b1c86dea1c36ae4bdac0848c188958d15d2e47"
		)
	]
)