...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.4.0-beta.19.xcframework.zip",
			checksum: "8ae39c2131b81eee7fdc7606ae7c43de8637cc85611ef137eb0fb102f4d4b9e3"
		)
	]
)