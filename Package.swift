...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230217195542.xcframework.zip",
			checksum: "56567bbb0d9e0ff843774449955b2563cf23131b72976198399562a87241b387"
		)
	]
)