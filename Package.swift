...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta.20230721115743.xcframework.zip",
			checksum: "14a359aa290bb7e540b05bfa02de2c27540ff374d3ee1e67be2c334af0f49865"
		)
	]
)