...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.3.0-beta.6.xcframework.zip",
			checksum: "320fa2eb6ef8ca3fef5d4bb1254c4e672576d0a31dd7655a08321011e689269b"
		)
	]
)