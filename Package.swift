...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-2.1.3.xcframework.zip",
			checksum: "7aac6cfafe2d269a05c9b8ff641858edee97aa152ba401ab5925762249f0bcfb"
		)
	]
)