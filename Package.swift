...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.4.0-beta.20.xcframework.zip",
			checksum: "62de86643be602496197b9ab4694836be5e1e1ac5ceb3e13d75ed4c768d03274"
		)
	]
)