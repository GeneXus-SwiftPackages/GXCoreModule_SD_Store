...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.0.0-beta.38.xcframework.zip",
			checksum: "188b43133695c3b8ac382a51682328f1c2d9914bf7344235fde6820c8c3a57c0"
		)
	]
)