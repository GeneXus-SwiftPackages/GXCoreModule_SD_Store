...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.15.xcframework.zip",
			checksum: "d5ae8ad908499bf7e37f3e0d3a4e4ff9ce12546bff1deb35674e987a40e10db9"
		)
	]
)