...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.1.0-beta.18.xcframework.zip",
			checksum: "a89f8b100378d5d873755c8cc9807fa1f84b4f741851a91db5d8c66bccf3d7ba"
		)
	]
)