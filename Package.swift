...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.0.0-beta.39.xcframework.zip",
			checksum: "29f69c3980ceaa7654ba91a967908322ca660db21a1a921c4af83bfe8279a105"
		)
	]
)