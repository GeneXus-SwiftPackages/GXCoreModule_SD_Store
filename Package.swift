...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-2.0.0-rc.32.xcframework.zip",
			checksum: "cce0d097d1d2b95ed8d25de7bb72a708d534a06e0ae1c33b96afc7f13c7eb664"
		)
	]
)