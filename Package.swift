...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.5.0-beta.12.xcframework.zip",
			checksum: "6a076ecea06b4c356a75ba517a66ff0a6d297b2f6d07185c6b9732944c683104"
		)
	]
)