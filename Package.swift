...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.2.0-beta.34.xcframework.zip",
			checksum: "ee6e60c848ece81371e38be7fdf55f28263f8e6097113c65a721cfab70e2528f"
		)
	]
)