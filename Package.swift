...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230420132651.xcframework.zip",
			checksum: "67b9e514a5f09b5d26f66bf3c8c6ccc926586f6e65e03542e18eb3bc48dde259"
		)
	]
)