...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-5.0.0-rc.1.xcframework.zip",
			checksum: "44f2d69bbe20c92c2ffe09726c92cdeeec651611f187565c43b91018e6912d4b"
		)
	]
)