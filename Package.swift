...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-4.0.0-rc.43.xcframework.zip",
			checksum: "2546c2bdbdd5fc0cd03ad0a11a60607cf56180a82c17180398a883c608862616"
		)
	]
)