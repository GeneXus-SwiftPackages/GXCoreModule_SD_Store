...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-3.2.0-rc.13.xcframework.zip",
			checksum: "f61e0aac4d8888b416373139722a79460806b61a96f6b7eafbb3d01e86de25a1"
		)
	]
)