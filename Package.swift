...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-1.5.0-rc.28.xcframework.zip",
			checksum: "bfa30b035e8e11136aad10148924929471a6805961669fd7951d39da2606b599"
		)
	]
)