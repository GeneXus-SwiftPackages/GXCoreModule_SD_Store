...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-3.1.0-rc.3.xcframework.zip",
			checksum: "8c5af206257bbf91fb97a1abbe81eb283db4d6e73000b24451db7ffc0f89682b"
		)
	]
)