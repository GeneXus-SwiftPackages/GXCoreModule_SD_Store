...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.1.0-beta.16.xcframework.zip",
			checksum: "846201ff67eeaf3e4c1ed4c5528ff9c8c92c35d44f07fe25702dd2c7998a9a0c"
		)
	]
)