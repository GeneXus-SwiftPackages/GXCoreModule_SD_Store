...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230314121632.xcframework.zip",
			checksum: "42f140e29ab965046deaa3388ff2b8f8909dfc03eac4b4c27e1fb80df6548da7"
		)
	]
)