...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.1.0-beta.26.xcframework.zip",
			checksum: "e3785fa813599a5e1b2c1a46771fdf65a89a15ad8488dfe700cbeaf786cda375"
		)
	]
)