...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.1.0-beta.20.xcframework.zip",
			checksum: "96b6c388a07fa7f316bc7b3aaf549e2ab6a3c7a1ca928996dc47e62cb44433ab"
		)
	]
)