...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.5.0-beta.18.xcframework.zip",
			checksum: "c5116d3554f1b8e9e26944ef15291e9587309c9abca2c6555da1b0adb8639b78"
		)
	]
)