...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-1.2.0.xcframework.zip",
			checksum: "01598522a0b9249917963bb6c4fcbdc86ef951891ca522377f07159d7fcd088f"
		)
	]
)