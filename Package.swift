...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta.20230616185027.xcframework.zip",
			checksum: "cd7558b57889f4915fffb6f37379c303f3940c6df90a74254ff38ef0f56e1e40"
		)
	]
)