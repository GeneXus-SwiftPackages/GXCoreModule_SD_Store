...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-5.0.0-beta.5.xcframework.zip",
			checksum: "f1ed70164c6614b69d772104b490bad344e8af68055c01ce58dc081416a2b3ae"
		)
	]
)