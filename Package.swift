...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-5.0.0-beta.1.xcframework.zip",
			checksum: "41673d37faa6cead518bddcb2734c155b55fc6bf017c8e1d4c8ac3f0c118ff17"
		)
	]
)