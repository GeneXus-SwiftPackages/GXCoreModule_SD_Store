...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.1.0-beta.18.xcframework.zip",
			checksum: "2906682309b580db8bb7f920d2546379755c463365d1bd2d717d596c9b762c6d"
		)
	]
)