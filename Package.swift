...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.35.xcframework.zip",
			checksum: "bf29bd8123d523181c4ba5b657d6733edd13bec29c5a021f499fb67b933cbd45"
		)
	]
)