...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-4.0.3.xcframework.zip",
			checksum: "c43d6b255c1777ab3e0ff5fb7920b663649a6b0e9c2a0a9bf4eebeb99d4eaa7d"
		)
	]
)