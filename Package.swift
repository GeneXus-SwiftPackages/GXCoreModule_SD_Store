...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-2.0.0-rc.36.xcframework.zip",
			checksum: "924adcc634e657d4c7715c1e0af2f854905c46420c171e8014b84d03846429a9"
		)
	]
)