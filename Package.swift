...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.1.0-beta.8.xcframework.zip",
			checksum: "2fa4f5c226eb532f144ad9146d7a8c5de0920b7e3e693fb0f62b4a808936ddc2"
		)
	]
)