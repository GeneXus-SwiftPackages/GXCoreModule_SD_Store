...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.2.0-beta.30.xcframework.zip",
			checksum: "3907afa62445a09ecb90c652eeabd6fbe30ddb07f6343e90eec2f139669d7b12"
		)
	]
)