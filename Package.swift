...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.0.0-beta.16.xcframework.zip",
			checksum: "9df4b20f6ede2f033371263e7b219d831eb36a4b078dabbfa2b216b3556fe1a7"
		)
	]
)