...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.1.0-beta.13.xcframework.zip",
			checksum: "341c8e4f6496ecbfbd108943f8c33dbfe17620d6627cf4d9ed2de8cf13f9f542"
		)
	]
)