...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.1.0-beta.19.xcframework.zip",
			checksum: "8f81a537c6fbad9e6192fe7fdd4bad9e14f77dd004559877a3f5300c888432f9"
		)
	]
)