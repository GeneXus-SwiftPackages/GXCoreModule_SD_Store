...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.4.0-beta.11.xcframework.zip",
			checksum: "6b3ba96bfc9ba9015533f3ce65519784be2a96e9adb01d5212633a048cf11859"
		)
	]
)