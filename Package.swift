...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.0.0-beta.7.xcframework.zip",
			checksum: "d97e03ab9ac05fcfafc0e3366ab2456c0b87f141fe2e9d6bd32d46e0d53c31c7"
		)
	]
)