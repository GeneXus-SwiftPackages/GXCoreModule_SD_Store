...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.30.xcframework.zip",
			checksum: "c5b37f31446090a381330f64b5949d689400db74250edf68b716b52584a5523d"
		)
	]
)