...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.2.0-beta.31.xcframework.zip",
			checksum: "c259fd1d022742f2272185953ee9eaccdc6d7edb88f7e8cfafe500911438407b"
		)
	]
)