...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230306105223.xcframework.zip",
			checksum: "9b10003e58e62d17d2236ac6cba51890edd0345009fb42ebd3965511b84a4614"
		)
	]
)