...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.2.0-beta.14.xcframework.zip",
			checksum: "33fd04e8d3eaedde7ac0886da174a78b6e671622e48fdb58b57040eeaaa39d55"
		)
	]
)