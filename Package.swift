...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-1.5.16.xcframework.zip",
			checksum: "50f9d2b2299bbca9fb7b2f3492698a5f9c7816ed89ac01365d2d57b8acf7d0e0"
		)
	]
)