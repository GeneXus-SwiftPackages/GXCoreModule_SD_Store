...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.2.0-beta.21.xcframework.zip",
			checksum: "2e1fd29b77494f62e3098af4d0d740f81d7ca55664a61812dd11f296782a116c"
		)
	]
)