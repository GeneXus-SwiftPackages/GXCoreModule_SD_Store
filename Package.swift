...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230601044120.xcframework.zip",
			checksum: "e4f366a318205c1a2ea8d9960fcff388765b731242a72ec08626244086d0c7b3"
		)
	]
)