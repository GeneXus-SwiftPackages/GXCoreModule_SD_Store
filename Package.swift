...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230606172938.xcframework.zip",
			checksum: "e7610a3ead78c9d286eef58531968727c22b916d8e5591f156542fb7bc5efa53"
		)
	]
)