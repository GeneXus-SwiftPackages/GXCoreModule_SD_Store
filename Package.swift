...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.2.0-beta.27.xcframework.zip",
			checksum: "04913b7bc01da0d1d8618268f6944ec10c7d7fc22b0463391f1a946eca3714b7"
		)
	]
)