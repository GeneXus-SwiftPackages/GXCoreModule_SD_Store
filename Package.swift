...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.20.xcframework.zip",
			checksum: "1af732d50c9476e636e3420542f45555c5fba3a3d09ac8a6c6f29caa22ff028d"
		)
	]
)