...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.6.xcframework.zip",
			checksum: "703c9abcb5a2693d9dd0f284d515e953d79766ab94a26564642057ae4103fb58"
		)
	]
)