...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.2.0-beta.9.xcframework.zip",
			checksum: "76b37244614efd1b2f908771ecf97ace6a08d1b152d2d27ac82733d56ec47ca5"
		)
	]
)