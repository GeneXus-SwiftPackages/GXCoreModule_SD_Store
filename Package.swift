...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-2.1.4.xcframework.zip",
			checksum: "c751a877b63aa5f8ad2c718e1c6e47691eec63ab08be34191eee0022e0b12ad0"
		)
	]
)