...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.6.0-beta.3.xcframework.zip",
			checksum: "d34a3bafc990ce43005ca5d1e168093a5b4ba6463be63c06c0b3745890aa5a6a"
		)
	]
)