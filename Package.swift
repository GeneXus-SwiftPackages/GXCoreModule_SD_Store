...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.2.0-beta.33.xcframework.zip",
			checksum: "2c1fc131669ab2b96482733fc90dc60ebebcdc9b787784b88f6cc4828626c222"
		)
	]
)