...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.1.0-beta.7.xcframework.zip",
			checksum: "512f1c3122c13d6a6111843f840e13994f51087ed8b2c773e12ed4f3625b1275"
		)
	]
)