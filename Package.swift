...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.1.0-beta.24.xcframework.zip",
			checksum: "cdd03f26000d5d35f1daa23982753decadcaa9995266e6172eb35c0184f0f422"
		)
	]
)