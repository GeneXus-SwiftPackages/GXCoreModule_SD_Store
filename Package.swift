...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.11.xcframework.zip",
			checksum: "cb6438afdd1d131feb46b39d9e4e0c179f4cf58c88f97b178c47a91deb2d76e1"
		)
	]
)