...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.4.0-beta.17.xcframework.zip",
			checksum: "79c1d809908e62c229690bf9fdedd7c813d7b7e19759bbe70dd3d94239b5d654"
		)
	]
)