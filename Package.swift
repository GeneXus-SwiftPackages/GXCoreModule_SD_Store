...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-1.2.0-rc.1.xcframework.zip",
			checksum: "d5698893a518fbb51e8269d3eee542bab4d3b2d4044482fb7422b07552abfb58"
		)
	]
)