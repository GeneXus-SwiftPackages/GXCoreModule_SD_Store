...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.5.0-beta.20.xcframework.zip",
			checksum: "c2f90b8f9cb853eac5a69bd347d428aa8c501a92ee0c4989084ff3f15b3f79f4"
		)
	]
)