...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.1.0-beta.3.xcframework.zip",
			checksum: "0b7da4b6966b31c0af612cc799179a52c4d8a16ad718feaa396b3dd94444c333"
		)
	]
)