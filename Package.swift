...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.2.0-beta.20.xcframework.zip",
			checksum: "acf52d486aad6d5a11cb1cf4cf2c643150d38b0766b180e9b11d05b4e1c3f6fa"
		)
	]
)