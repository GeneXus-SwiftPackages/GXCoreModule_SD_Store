...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.1.0-beta.2.xcframework.zip",
			checksum: "a8aa06c15471b2c73a5b3cbc80475400f974187aa0c27db8161a03c8c0f4356d"
		)
	]
)