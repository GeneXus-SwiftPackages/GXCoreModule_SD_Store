...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-1.3.0-rc.7.xcframework.zip",
			checksum: "a0f77cdedbcd544fcfbb8d61e07f2cb4c2266b2653cfe83931acb1cde09f5721"
		)
	]
)