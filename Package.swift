...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.0.0-beta.37.xcframework.zip",
			checksum: "c1845019b34a48a5cc7cd0ca2c4fe219d3ff644e848c9b1d668ff6b65d0c23be"
		)
	]
)