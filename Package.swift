...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-1.5.12.xcframework.zip",
			checksum: "539c915cdcf85344c858b742327e908f90532340a6b2c64f2c3a1b5bcdb76f34"
		)
	]
)