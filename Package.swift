...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-2.2.0-rc.3.xcframework.zip",
			checksum: "eee53ad91c04a4aea89b1ea9741eae6989cbd294e3f41ca205a11428fad5e3ee"
		)
	]
)