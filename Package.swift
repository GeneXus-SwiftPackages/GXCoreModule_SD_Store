...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.2.0-beta.26.xcframework.zip",
			checksum: "d76ba061fc49a2e75fe85079baef44b73fdf630b248610794b631b84284f7854"
		)
	]
)