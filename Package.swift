...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-1.5.11.xcframework.zip",
			checksum: "70ee4de0c28cd890bee6bf6b36d87381861430ba164264857a5ab5992b3d330c"
		)
	]
)