...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-1.4.29.xcframework.zip",
			checksum: "4f9e418e6d1c5fe609733b110514fec05765f86382a9ad6f7a9ca726932db6c1"
		)
	]
)