...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.2.0-beta.31.xcframework.zip",
			checksum: "de1881525790d87776bf88277d0b5baa590a5e86577f6e56fedeee9bad5e3f1a"
		)
	]
)