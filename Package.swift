...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.1.0-beta.5.xcframework.zip",
			checksum: "0114b892d0dea8953ac690ef2ddac2ec53376b5f433222d57212fe04fea6697a"
		)
	]
)