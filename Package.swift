...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.2.0-beta.30.xcframework.zip",
			checksum: "7a6e105b8d84f86badf62fab3262a77775832756ce017744d6cd740341a843a0"
		)
	]
)