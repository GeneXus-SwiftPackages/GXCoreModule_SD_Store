...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-1.1.0-rc.4.xcframework.zip",
			checksum: "f638eda4872c50eee5ab79347b13722fd6d7cc71f980cec2b262b62cabd7c31c"
		)
	]
)