...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.17.xcframework.zip",
			checksum: "276757a89a23eaf47f49b6c3adec26237d4b5cf447c6a7d46b445bb7c0befa41"
		)
	]
)