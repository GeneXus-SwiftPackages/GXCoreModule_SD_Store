...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.5.0-beta.15.xcframework.zip",
			checksum: "5dee18f6f2ea75898fb6bde755a631a4215e458d767dedac53834595d8e3d9f0"
		)
	]
)