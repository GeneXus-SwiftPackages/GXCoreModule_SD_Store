...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230519205149.xcframework.zip",
			checksum: "acf4ef43d89b4b944ec0890fd495a9c7c855ed7fe29c19c7ec5a43cebce4949b"
		)
	]
)