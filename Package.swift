...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-1.4.0-rc.5.xcframework.zip",
			checksum: "ebbd430b99fff65b1eb30792c839a049d17dac021940891247f6867ff49c6bfe"
		)
	]
)