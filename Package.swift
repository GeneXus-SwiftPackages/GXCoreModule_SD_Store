...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.14.xcframework.zip",
			checksum: "cd84de26d6f8eeba5ac8df4b25236b0625e2c5087085368bbf89f7f63dfac30c"
		)
	]
)