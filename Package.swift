...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.0.0-beta.17.xcframework.zip",
			checksum: "ee36f89385ed99d33c7d38d03d89d5a061adc2d08cdee64950d802ba51843858"
		)
	]
)