...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230515145153.xcframework.zip",
			checksum: "498e518456d600daa18b7b38df0e9cf136cbe9637ef1c4874c39d3be9072ba5b"
		)
	]
)