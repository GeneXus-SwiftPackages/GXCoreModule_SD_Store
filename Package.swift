...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.4.0-beta.13.xcframework.zip",
			checksum: "a825a1a0d8687f0ab247cabe61e0d78807c50bd102e3fd5612498e091febdae1"
		)
	]
)