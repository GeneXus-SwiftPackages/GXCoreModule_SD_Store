...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.0.0-beta.5.xcframework.zip",
			checksum: "8f5dfbf851cfd104a90ef424465f138e5caed8383fa8dad0be6763f3f0dada07"
		)
	]
)