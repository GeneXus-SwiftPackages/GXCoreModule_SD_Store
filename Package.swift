...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-2.0.0-rc.22.xcframework.zip",
			checksum: "d881907b666a30766c54ef3651295db8d2675a6c6e936ea3e83a765c13a5485c"
		)
	]
)