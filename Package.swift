...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.9.xcframework.zip",
			checksum: "cf15d89472271de8bdac9f0638fdaeb85a7f5f9e846d417b510e47c57f863602"
		)
	]
)