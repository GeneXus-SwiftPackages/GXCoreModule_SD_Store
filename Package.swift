...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.2.0-beta.18.xcframework.zip",
			checksum: "58644f97b3cbf7cc8409eda29f7ee9ed3153c94c3b8c505efe8d57335edcd6c4"
		)
	]
)