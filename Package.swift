...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230515023341.xcframework.zip",
			checksum: "f1143645944baae7b80df68d14999bdea9873f765d12a9edf507172052623eab"
		)
	]
)