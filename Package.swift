...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-4.1.0-rc.25.xcframework.zip",
			checksum: "99834155762e3ec7c9610ba1139263396f6726b9ae0c6b2e81eec1110e99f286"
		)
	]
)