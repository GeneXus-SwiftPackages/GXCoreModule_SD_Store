...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.39.xcframework.zip",
			checksum: "a071e0a5fd48cf27bc2724b7c63c1b3b65f2291900a6d2658da4639695c701a5"
		)
	]
)