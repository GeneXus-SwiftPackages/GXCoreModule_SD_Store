...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta.20230620165651.xcframework.zip",
			checksum: "ea51e179adcbac043a38c4170dbc23e452334d3223c7b25dd92c2a0f90cccc49"
		)
	]
)