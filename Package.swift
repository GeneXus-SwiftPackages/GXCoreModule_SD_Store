...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.3.0-beta.8.xcframework.zip",
			checksum: "c2f7c56dfb7ba3091580789e2b7794eb7f71b6691448818d268f98697f8b0a97"
		)
	]
)