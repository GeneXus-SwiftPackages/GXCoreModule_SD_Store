...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230418130717.xcframework.zip",
			checksum: "98177c522045de698a801bf55e40c80489c649cfb78fff6926fa31eca2e2ca58"
		)
	]
)