...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.2.0-beta.25.xcframework.zip",
			checksum: "4c189d9b495c4a49f305378dd85a3edf35e8e6c302f7dd06944b2be8d9bb3557"
		)
	]
)