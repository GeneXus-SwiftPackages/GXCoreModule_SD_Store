...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230316174639.xcframework.zip",
			checksum: "9f1dfcb9b09776c2d8e413639622956e292868b0d80e5816dfaad64e3eaf8dea"
		)
	]
)