...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-3.2.0-rc.10.xcframework.zip",
			checksum: "576a5acef00875a78ba8390cdeadccff76eb76f9e3ecf35ab35ed93b52410bf8"
		)
	]
)