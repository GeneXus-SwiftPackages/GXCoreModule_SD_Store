...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.5.0-beta.28.xcframework.zip",
			checksum: "00acc25554cb707d7d4f66795573ea11a4a40835e644455995eb10bef55209aa"
		)
	]
)