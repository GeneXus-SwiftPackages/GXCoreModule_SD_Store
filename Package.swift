...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.0.0-beta.40.xcframework.zip",
			checksum: "4fafe7ec3824a0c3cd66a804524c0adf19d3155cafa15a0cdf55c075d70e51f3"
		)
	]
)