...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-2.1.0-rc.23.xcframework.zip",
			checksum: "dde0c37eb6ec273f22345e4ea5527a7fb11d4c3d98298e005afb3fa85a54cd5b"
		)
	]
)