...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.0.0-beta.23.xcframework.zip",
			checksum: "2bf031b78a7f1a53614581dccd29b0c4111f680739f8591927c7b269cd0ebe1d"
		)
	]
)