...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.1.0-beta.27.xcframework.zip",
			checksum: "9e63e4677a15e631d03c37ed318a96faa66a4621da57ac941ba99a63c241ab6e"
		)
	]
)