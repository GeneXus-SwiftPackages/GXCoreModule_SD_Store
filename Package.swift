...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.3.0-beta.10.xcframework.zip",
			checksum: "e8cc86047bcae2297a4b70cf589b8240687ed9385fcff2ac0a8ce119c25f9ea1"
		)
	]
)