...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-1.4.26.xcframework.zip",
			checksum: "469cf63c7c0bdf682a1e2ed6a3301cc3056bbe59d7f8bd73d252440ad2138cf2"
		)
	]
)