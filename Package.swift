...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta.20230704143346.xcframework.zip",
			checksum: "a7f972c17a0e561850581388e8f37bf794d52d9d603270267160a7c8d4f78c02"
		)
	]
)