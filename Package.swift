...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.1.0-beta.8.xcframework.zip",
			checksum: "9b5cc439654d4bb00fceee79b23d737b1f43d7cab7682dca0062cc050a3c0166"
		)
	]
)