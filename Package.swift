...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-4.0.7.xcframework.zip",
			checksum: "f6691307ab661f4913a264cb7fcc82c106123b4bcc2a5d5daa7fd1a511188d8a"
		)
	]
)