...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.1.0-beta.25.xcframework.zip",
			checksum: "9551a76e50fb529cec4162dca073888aa151e46690408b2a70dba45740880235"
		)
	]
)