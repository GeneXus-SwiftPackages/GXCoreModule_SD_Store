...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.2.0-beta.9.xcframework.zip",
			checksum: "9b0ee5f9d2ccc4955da02bc1e6712c95a2103a948036b74ce1fd0abc97f232c6"
		)
	]
)