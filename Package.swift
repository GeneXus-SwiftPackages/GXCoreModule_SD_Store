...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230309154144.xcframework.zip",
			checksum: "7e9ac69fa5c8d85d034dfd4d61d18ee8e6ca34d6eae1f69bb4695bd6845fe25c"
		)
	]
)