...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.27.xcframework.zip",
			checksum: "615f3a6eee976e1e006cfdd8e53e56d039d809fe9e1890c7d0fec39aafa3de6c"
		)
	]
)