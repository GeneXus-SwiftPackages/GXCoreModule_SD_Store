...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.23.xcframework.zip",
			checksum: "63a03d42d670e25498b37270ccdc973c2dab207c571a64176219667c0dfea715"
		)
	]
)