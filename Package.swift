...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.2.0-beta.15.xcframework.zip",
			checksum: "039247ccb1a43cbc5bd01f9d1f5b6b324527a6898f364e0bd88180707b80df32"
		)
	]
)