...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.2.0-beta.27.xcframework.zip",
			checksum: "e31f6564181ae0ba087f1eb626381621a787d479d5a22f813dd514e65bbb3364"
		)
	]
)