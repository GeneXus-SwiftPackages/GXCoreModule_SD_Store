...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-3.2.0-rc.0.xcframework.zip",
			checksum: "03a36f2d1e7ce89c3420ef9b00028ea4b9a5354d7f7780a39736cbfe7d435ef7"
		)
	]
)