...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.0.0-beta.29.xcframework.zip",
			checksum: "4f131f3a5b10ac40e9d1f75c582a63ccf7ccc81098f30878636a46a3b1b80532"
		)
	]
)