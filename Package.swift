...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.2.0-beta.13.xcframework.zip",
			checksum: "4b83a35de2e4562bd62a10bafdd7e22fa3166cec39ec57be46f21cf017a8e378"
		)
	]
)