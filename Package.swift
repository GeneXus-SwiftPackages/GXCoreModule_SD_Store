...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-2.1.0-rc.25.xcframework.zip",
			checksum: "8fe060f3fba5b94c2ef84a1cf6026b87966115377061efbfcdcb7d29f9841ad1"
		)
	]
)