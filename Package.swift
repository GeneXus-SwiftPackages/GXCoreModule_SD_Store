...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.2.0-beta.19.xcframework.zip",
			checksum: "cb250d8ae63f68673fb5240fff35af9f14b7910d20c031a5b57fd94436d1c6e7"
		)
	]
)