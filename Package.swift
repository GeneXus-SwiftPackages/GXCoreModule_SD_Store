...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.2.0-beta.28.xcframework.zip",
			checksum: "9587c22545796fa6f9bc082d1fd7b98dd924a6bf3952d1257317a85f6c44fa4b"
		)
	]
)