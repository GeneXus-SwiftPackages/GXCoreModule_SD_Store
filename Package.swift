...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.0.0-beta.4.xcframework.zip",
			checksum: "f68e8b3ceed6bf48e3af9204ced4d20572566835b9ff96a3b853c21eff80ffc3"
		)
	]
)