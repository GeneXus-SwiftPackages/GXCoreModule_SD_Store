...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.1.0-beta.12.xcframework.zip",
			checksum: "cbd52e805255e50512bab75c9e00252536a14f09636a2c1068972d81143c95ce"
		)
	]
)