...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.1.0-beta.10.xcframework.zip",
			checksum: "d786589e034f8e4ab4c56846ae359b5f1ebf131ab5481480c4127280eb0b75ff"
		)
	]
)