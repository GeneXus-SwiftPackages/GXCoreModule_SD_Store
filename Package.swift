...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230405133406.xcframework.zip",
			checksum: "dca956adaf105ee147a4e36e54e930f66bd1401365837ab925d59f0e071eed3b"
		)
	]
)