...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-4.1.3.xcframework.zip",
			checksum: "ad509a0bff9f7a5b0158b4ef2d5a673dc402ad8e930837ab5df47f81b7265426"
		)
	]
)