...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store-4.2.0-rc.13.xcframework.zip",
			checksum: "09bf68f772dcb1a78b6ee7c0e4db28c5f4308cccc2ec0c9014c2fe24727948d4"
		)
	]
)