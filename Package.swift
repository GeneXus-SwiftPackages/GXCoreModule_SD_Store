...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-4.2.0-beta.6.xcframework.zip",
			checksum: "c5ad51273ad2be6479a6e34039dcb67a240082e63a9fb776f22e451fad933697"
		)
	]
)