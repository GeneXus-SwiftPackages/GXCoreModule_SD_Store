...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.0.0-beta.19.xcframework.zip",
			checksum: "a91f3afc0a592d8cd9b53402bdeb3cfdbbc92abdca5c9952119230b0844b8bfe"
		)
	]
)