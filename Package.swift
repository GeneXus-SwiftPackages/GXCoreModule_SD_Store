...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230328162416.xcframework.zip",
			checksum: "c7dc6e588d99461547836999a8ddbd7923c1b8fba73d208dc84f37f4717e0a79"
		)
	]
)