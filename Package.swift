...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-1.3.5.xcframework.zip",
			checksum: "81eb5f718a93a1a078ad619ec998790f710e720b266114dda308016d5e841743"
		)
	]
)