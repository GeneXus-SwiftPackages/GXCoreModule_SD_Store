...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.5.0-beta.13.xcframework.zip",
			checksum: "45b99257d0b6a76e32f3abe6d4ac21f4478e9eb03e5f707368d0421c3542d243"
		)
	]
)