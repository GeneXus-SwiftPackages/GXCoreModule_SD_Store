...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-1.1.3.xcframework.zip",
			checksum: "e1fd560193dc7355814e89ef6e3ec93c5439de1e08630fe99817a40f77091483"
		)
	]
)