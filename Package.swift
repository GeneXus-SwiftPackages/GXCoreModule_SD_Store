...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-2.0.17.xcframework.zip",
			checksum: "907ebf81f2606dc34152126ab06dc0a033b1d4e2a3bf319f76040acd6d9e29a3"
		)
	]
)