...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta.20230710170706.xcframework.zip",
			checksum: "80dbc1b1de6fba086e4c1c66415500ac5e5073da29bcee3db47f6c24893569a9"
		)
	]
)