...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-4.0.6.xcframework.zip",
			checksum: "b8e676829b094c1ea335e7ff80ecc53e2bfe6f04c884e38e0e1f53a69fedea24"
		)
	]
)