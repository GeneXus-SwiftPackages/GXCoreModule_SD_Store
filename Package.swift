...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230315182831.xcframework.zip",
			checksum: "b88e61c5b709e8d0d766811496b0fe9fac1f92060537dbc8f9908464f0b526a7"
		)
	]
)