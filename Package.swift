...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.2.0-beta.24.xcframework.zip",
			checksum: "fab1026503b0b9cfd8c31bf672104c7d145278ec82c6cec79551adf88744b176"
		)
	]
)