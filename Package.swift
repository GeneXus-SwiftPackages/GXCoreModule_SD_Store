...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta+20230524184838.xcframework.zip",
			checksum: "29fc750ff091b803b805f914f1d2082e3e86bdca9e74a12df686ef6497f918fd"
		)
	]
)