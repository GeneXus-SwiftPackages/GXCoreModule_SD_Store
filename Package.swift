...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.5.0-beta.17.xcframework.zip",
			checksum: "26d65ff57d56d02fa1adb73b92765a9761bce8e5f3fcbcb4c4687245c6ccd7a7"
		)
	]
)