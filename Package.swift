...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-1.0.0-beta.20230710193719.xcframework.zip",
			checksum: "f64c472a893381997be90d8704b752ff68a4059bb13c055e77e670867c7e35b8"
		)
	]
)