...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store-3.1.1.xcframework.zip",
			checksum: "8d8acacaa96ef9c3c53ab5fd6e108b2a52ecb052f30f61d996ed1740d50e09cf"
		)
	]
)