...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.0.0-beta.36.xcframework.zip",
			checksum: "a437a5b3ddd7b615c73485b94ebdea1074f0ca06de1646dc15f05f972b16d764"
		)
	]
)