...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.31.xcframework.zip",
			checksum: "de1fdbe57c358388f6e680cb01060430324713829f29c81672f264a64f58ab6d"
		)
	]
)