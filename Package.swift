...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.2.0-beta.26.xcframework.zip",
			checksum: "1a16becd8b81adc2b31b142e9c2142f2afa68f747c921d54955c838df33cbc57"
		)
	]
)