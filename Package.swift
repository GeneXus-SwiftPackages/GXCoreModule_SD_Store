...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.2.0-beta.29.xcframework.zip",
			checksum: "85f4052f67e4586d11c736f7fab1708fe36b2e4feaed075d9e9e69ec9856d9fd"
		)
	]
)