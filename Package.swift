...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-2.1.0-beta.26.xcframework.zip",
			checksum: "33cd31fe3c8cea025cb219b5ba72f11e884f650e0d079cf0aba1ce5c94a8bb7a"
		)
	]
)