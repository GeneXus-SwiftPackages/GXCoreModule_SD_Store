...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store-3.0.0-beta.12.xcframework.zip",
			checksum: "35c443d9fc5031f443cd23b5a952d433c025f12dd2fc99b30de0c26104237bc2"
		)
	]
)